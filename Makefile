...
# USIP = uisp -dprog=avr910 -dserial=$(SERIAL) -dpart=auto
UISP = avrdude -c usbtiny -p m88 -F 
# The two lines above are for "uisp" and the AVR910 serial programmer connected
# to a Keyspan USB to serial converter to a Mac running Mac OS X.
# Choose your favorite programmer and interface.

COMPILE = avr-gcc -Wall -Os -Iusbdrv -I. -mmcu=atmega88 #-DDEBUG_LEVEL=1
...
#        +-------------------- BODLEVEL (2.7V)
fuse:
	$(UISP) -U hfuse:w:hfuse-0xc9.val -U lfuse:w:lfuse-0x9f.val
